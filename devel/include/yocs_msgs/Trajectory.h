...
struct Trajectory_
{
  ...
  _name_type name;
   ...
   typedef std::vector< ::yocs_msgs::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::yocs_msgs::Waypoint_<ContainerAllocator> >> _waypoints_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::yocs_msgs::Trajectory_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.waypoints.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::yocs_msgs::Waypoint_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.waypoints[i]);
    }
    if (v.waypoints.empty() || false)
      s << "]";
  }
